...
describe('Test cases for Login flow', () => {
    ...
    beforeEach(() => {
        cy.viewport(430, 932); // Configura la resolución para iPhone 15 Pro Max
    ...
    context('Login flow', () => {
        ...
        it('LOG-005: Verify that a logged-in user can log off', () => {
            ...
            // Seleccionar el elemento con el selector data-action="toggle-nav" y hacer clic en él
            cy.get('span[data-action="toggle-nav"]').click();
